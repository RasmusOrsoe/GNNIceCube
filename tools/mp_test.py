...
def MakeGraph(setting): 
    seq,sca,node_size,path,file, SRT, edge_config, scaling, fullgrid = setting
    if scaling == 'Standard':
        ...
        for file2 in os.listdir(path):
            ...
            if file.endswith(".csv"): 
                ...
                if types_sca == types_seq2 and file[10:15] == file2[10:15]:
                    ...
                    settings.append(tuple([seq2, sca, 48, 'J:\\speciale\\results\\graphs\\40-48-split',file,False,'Time','Standard',True]))
                if types_sca2 == types_seq and file[10:15] == file2[10:15]:
                    ...
                    settings.append(tuple([seq, sca2, 48, 'J:\\speciale\\results\\graphs\\40-48-split',file,False,'Time','Standard',True]))
