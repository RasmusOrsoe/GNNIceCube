...
if __name__ == '__main__':
    ...
    base = 'dynedge-protov2-zenith-indiconv-k=%s-c3not3-%s'%(args.k, args.tag)
    ...
    #trained_model = torch.load('/groups/hep/pcs557/speciale/results/dev_level7_mu_e_tau_oscweight_000/event_only_level7_all_oscweight_muon/dynedge-protov2-zenith-k=8-c3not3/model.pkl').to(device)
