...
graphs_train = GrabGraphs(path = r'J:\speciale\data\graphs\dev_numu_train_l5_retro_001\event_no_check\train')
...
#=============================================================================
graphs_valid = GrabGraphs(r'J:\speciale\data\graphs\dev_numu_train_l5_retro_001\event_no_check\valid')
count = 0
target = list() 
res = list()
val_events = list()
