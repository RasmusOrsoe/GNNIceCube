...
class Net(torch.nn.Module):                                                     
    def __init__(self):                                                                                   
        ...
        l1, l2, l3, l4, l5,l6,l7 = 5,3*16*2,3*32*2,3*42*2,3*32*2,3*16*2,1
...
if __name__ == '__main__':
    handle = 'dev_numu_train_l5_retro_001\event_only_aggr_test_SRT_energy_scaled_weights'
    base = 'dynedgev3-zenith'
