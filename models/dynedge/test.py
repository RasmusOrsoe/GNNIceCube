...
class Net(torch.nn.Module):                                                     
    def __init__(self):                                                                                   
        ...
        self.nn1 = torch.nn.Linear(l1,l7)                                               
...
def Validate(trained_model,graphs_valid,graphs_train,batch_size,
    ...
    with torch.no_grad():
        for i in range(0, mini_batches_valid):                                                  
            ...
            w                               = data_pred.lw 
            #loss = NMAELoss(pred,data_pred.y,w)
...
if __name__ == '__main__':
    ...
    handle = 'dev_upgrade_train_step4_001\event_only_shuffled_input-_target-_bjørn_weights_wild'
    base = 'dynedgev3-baseline-4-LeakyReLu-low_weight_profile_gradtest'
    ...
    #trained_model = torch.load(r'X:\speciale\results\dev_upgrade_train_step4_001\event_only_shuffled_input-_target-_bjørn_weights\dynedgev3-baseline-4-LeakyReLu-low_weight_profile_meanloss\model.pkl')
