...
class Net(torch.nn.Module):                                                     
    def __init__(self):                                                                                   
        ...
        l1, l2, l3, l4, l5,l6,l7 = 11,16*2,32*2,64*2,32*2,16*2,1
...
if __name__ == '__main__':
    ...
    handle = 'dev_numu_train_upgrade_step4_2020_00\event_only_shuffled_input(0,1)_target-_bjorn_weights'
    base = 'dynedgev3-baseline-4-LeakyReLu_high_weight_profile'
