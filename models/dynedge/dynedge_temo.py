...
def Train(loader,n_reps,n_epochs,mini_batches,batch_size,lr_list,lr):
    loss_list = list()
    epoch_list = list()                                                                                  
    count = torch.tensor([0]).to(device)
    model = Net().to(device)
...
graphs_train = GrabGraphs(path = r'J:\speciale\data\graphs\dev_numu_train_l5_retro_001\event_only_shuffled(0,1)(1,4)\train')
...
base = 'dynedge_retro_noweight_test'
...
#=============================================================================
graphs_valid = GrabGraphs(r'J:\speciale\data\graphs\dev_numu_train_l5_retro_001\event_only_shuffled(0,1)(1,4)\valid')
count = 0
target = list() 
res = list()
model.eval() 
