...
class Net(torch.nn.Module):                                                     
    def __init__(self):                                                                                   
        ...
        self.nn5 = torch.nn.Linear(4*l7,l7)
    ...
    def forward(self, data):                                                    
        ...
        x = self.relu(x)
        x = self.nn4(x)
        x = torch.cat((x,data.model_low,data.model_high,data.model_nw),dim = 1)
        x = self.relu(x)
...
if __name__ == '__main__':
    ...
    base = 'dynedgev3-multi-ensemble-epoch50'
    ...
    #trained_model = torch.load(r'X:\speciale\results\dev_numu_train_l5_retro_001\event_only_aggr_test_SRT_energy_scaled_new_weights\dynedgev3-multi-high\model.pkl')
