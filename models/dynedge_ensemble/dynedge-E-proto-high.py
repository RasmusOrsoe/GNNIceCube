...
if __name__ == '__main__':
    ...
    trained_model = torch.load('/groups/hep/pcs557/speciale/results/dev_numu_train_l5_retro_001/event_only_aggr_test_SRT_energy_scaled_new_weights/dynedge-E-proto-high/model.pkl')
