...
if __name__ == '__main__':
    ...
    trained_model = torch.load('/groups/hep/pcs557/speciale/results/dev_level7_mu_tau_e_retro_000/event_only_level7_all_neutrinos_retro_SRT_4mio/dynedge-E-protov2-zenith/model.pkl').to(device)
