...
if __name__ == '__main__':
    handle = 'dev_numu_train_l5_retro_001\event_only_SRT_zenith_azimuth_not_scaled'
    base = 'dynedgev3-likelihood-az-zen-no-eps-noreg'
    ...
    #trained_model = torch.load(r'X:\speciale\results\dev_numu_train_l5_retro_001\event_only_aggr_test_SRT_energy_scaled_new_weights\dynedgev3-likelihood-az-zen-no-eps\model.pkl')
