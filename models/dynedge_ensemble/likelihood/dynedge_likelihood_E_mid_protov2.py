...
def Predict(model,prediction_graphs,n_workers,pred_mini_batches,batch_size,o,handle,baseline):
    ...
    with torch.no_grad():
        ...
        result          = pd.concat([pred_events,truths, predictions,sigma],axis = 1)
        result.columns  = ['event_no','energy_log10','energy_log10_pred', 'energy_log10_pred_sigma']
...
if __name__ == '__main__':
    ...
    handle = 'dev_level7_oscNext_IC86_003/event_only_level7_all_oscNext_IC86_003' #'dev_level7_mu_tau_e_retro_000/event_only_level7_all_neutrinos_retro_SRT_4mio' 
    base = 'dynedge-E-protov2-likelihood'
    ...
    trained_model = torch.load('/groups/hep/pcs557/speciale/results/dev_level7_mu_tau_e_retro_000/event_only_level7_all_neutrinos_retro_SRT_4mio/dynedge-E-protov2-likelihood/model.pkl')
